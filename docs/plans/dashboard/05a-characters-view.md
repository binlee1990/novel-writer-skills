...
## Task 20: CharactersView 完整实现

**Files:**
- Modify: `dashboard/src/views/CharactersView.vue`

```vue
<!-- dashboard/src/views/CharactersView.vue -->
<template>
...
```bash
git add dashboard/src/views/CharactersView.vue
git commit -m "feat(dashboard): implement CharactersView with card grid, filters, and arc timeline"
```
