...
## Task 24: ChaptersView 完整实现

**Files:**
- Modify: `dashboard/src/views/ChaptersView.vue`

```vue
<!-- dashboard/src/views/ChaptersView.vue -->
<template>
...
```bash
git add dashboard/src/views/ChaptersView.vue
git commit -m "feat(dashboard): implement ChaptersView with tree nav, heatmap, and chapter cards"
```
